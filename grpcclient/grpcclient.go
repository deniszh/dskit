...
import (
	"flag"
	"github.com/grafana/dskit/grpcencoding/ddzstd"
	"github.com/grafana/dskit/grpcencoding/s2"
	"github.com/grafana/dskit/grpcencoding/zstd"
	"time"
...
func (cfg *Config) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.StringVar(&cfg.GRPCCompression, prefix+".grpc-compression", "", "Use compression when sending messages. Supported values are: 'gzip', 'snappy', 's2', 'zstd', 'ddzstd' and '' (disable compression)")
...
func (cfg *Config) Validate() error {
	...
	case gzip.Name, snappy.Name, s2.Name, zstd.Name, ddzstd.Name, "":
		// valid
	default:
